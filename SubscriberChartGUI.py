from tkinter import Canvas, Frame, Button, Tk
import threading
import time
...
class DisplayChart(Frame):
    ...
    def _translate_point(self, x: float, value: float) -> tuple[float, float]:
...
class DisplayChartApp:
    ...
    def draw_chart(self, start_index: int = 0, end_index: int = None):
        ...
        self._chart.draw_x_axis("Tempreture", self.subscriber.data_ids[start_index:end_index])
        self._chart.draw_y_axis("Time", 1, "C")
